...
public interface TaskToService extends PagingAndSortingRepository<TaskTo, Long>, JpaSpecificationExecutor<TaskTo> {
    ...
    List<TaskTo> findByPersonIdAndClosedIsNullAndTaskCloseType(Long personId, CloseType closeType);

    List<TaskTo> findByPersonIdAndClosedIsNullAndTaskCloseTypeAndTaskPersonId(Long personId, CloseType closeType, Long taskPersonId);
}
