app.controller("closedSoonOutgoingCtrl", ['$scope', '$rootScope', '$timeout', 'TaskService', 'ModalProvider',
    function ($scope, $rootScope, $timeout, TaskService, ModalProvider) {
        ...
        $scope.refresh = function () {
            switch ($scope.viewType){
                case 'المهام الصادرة المغلقة هذا اليوم':
                    $scope.fetchThisDay();
                    break;
                case 'المهام الصادرة المغلقة هذا الاسبوع':
                    $scope.fetchThisWeek();
                    break;
                case 'المهام الصادرة المغلقة هذا الشهر':
                    $scope.fetchThisMonth();
                    break;
                case 'المهام الصادرة المغلقة هذا العام':
                    $scope.fetchThisYear();
                    break;
            }
        };
